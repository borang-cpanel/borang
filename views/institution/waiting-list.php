...
$this->title = 'Waiting List Patient';
$this->params['breadcrumbs'][] = $this->context->title;
$this->params['breadcrumbs'][] = $this->title;

?>
<h3><?= $this->title?></h3>
<p>Angka yang tercantum di sini adalah lama waiting-list terkini dalam satuan minggu</p>
<div class="item-index">
    <div id="ajaxCrudDatatable">
        <?=GridView::widget([
            ...
            'pjax'=>false,
            'columns' => $this->context->waitinglistFields(),
            'toolbar'=> [
                ['content'=>
                    ''
                ]
