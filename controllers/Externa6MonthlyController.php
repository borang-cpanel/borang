...
class Externa6MonthlyController extends PostDetailController{
	protected $title = 'Patient Externa';
	protected $periodType = '6 Monthly';

	public function init()
	{
		parent::init();
		$this->setModelName('\app\models\Externa6Monthly');
