 ...
 */
class ExternaYearly extends Externa
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['institution_id', 'period', 'total', 'case', 'radiation_2d', 'radiation_3d', 'radiation_imrt', 'radiation_vmat', 'radiation_srt', 'radiation_srs', 'radiation_sbrt', 'radiation_igrt'], 'required'],
