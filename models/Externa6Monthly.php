 ...
 */
class Externa6Monthly extends Externa
{
    ...
    public function formFields()
    {
        return [
            ...
            [
                'name'=>'case',
                'type'=>'multiform',
                'hint'=>'Isi 10 Kasus Kanker terbanyak. Anda tidak perlu menulis "%" di kolom Persentase, 
                    cukup tulis angkanya saja. Pastikan total keseluruhan adalah 100',
                'options'=>
                    [
                        'number'=>10,
                        'fields'=>[
    ...
    {
        list($this->period_year, $quarter) = explode('-', $this->period);
        switch($quarter){
            case 'S1':return $this->period_year.'- Jan-Jun';break;
            case 'S2':return $this->period_year.'- Jul-Dec';break;
        }
    }
