 ...
 */
class Externa extends \app\components\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['institution_id', 'period_type', 'period', 'total', 'case', 'radiation_2d', 'radiation_3d', 'radiation_imrt', 'radiation_vmat', 'radiation_srt', 'radiation_srs', 'radiation_sbrt', 'radiation_igrt'], 'required'],
    ...
    public function formFields()
    {
        return [
            [
                'name'=>'period_type',
                'type'=>'hidden',
                'data'=>['Monthly', '3 Monthly', '6 Monthly', 'Yearly']
            ],
            [
                'name'=>'period',
                'type'=>'text',
    ...
    {
        return self::find()->where(['institution_id'=>$institutionId])->andWhere(['like','period', $year])->sum('total');
    }
